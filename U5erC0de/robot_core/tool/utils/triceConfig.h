...
#define TRICE_RTT_CHANNEL 0 //!< Uncomment and set channel number for SeggerRTT usage.
    // #define TRICE_UART USART1   //!< Uncomment and set UART for serial output.
...
#define TRICE_TIMESTAMP HAL_GetTick()
...
#define TRICE_HEADLINE                                                       \
    TRICE0(Id(57449), "s:                                          \n");     \
    TRICE8(Id(36291), "s:     STM32     TRICE_MODE %3u     \n", TRICE_MODE); \
    TRICE0(Id(34640), "s:                                          \n");     \
    TRICE0(Id(52064), "s:     ");                                            \
    TRICE_BUFFER_INFO;                                                       \
    TRICE0(Id(46427), "s:     \n");                                          \
...
#include "main.h" // hardware specific stuff
    ...
    TRICE_INLINE uint32_t triceTxDataRegisterEmpty(void)
    {
        ...
        return (READ_BIT(TRICE_UART->SR, USART_SR_TXE) == (USART_SR_TXE));
    }
    ...
    TRICE_INLINE void triceEnableTxEmptyInterrupt(void)
    {
        ...
        SET_BIT(TRICE_UART->CR1, USART_CR1_TXEIE);
    }
    ...
    TRICE_INLINE void triceDisableTxEmptyInterrupt(void)
    {
        ...
        CLEAR_BIT(TRICE_UART->CR1, USART_CR1_TXEIE);
    }
