...
#define GBIAS_ACC_TH_SC                 (2.0f*0.1f)
#define GBIAS_GYRO_TH_SC                (2.0f*0.088f)
 ...
 * @retval None
 */
void mfx_manager_run(MFX_input_t *data_in, MFX_output_t *data_out, float delta_time)
{
 ...
 * @retval None
 */
void mfx_manager_start_6X(void)
{
 ...
 * @retval None
 */
void mfx_manager_start_9X(void)
{
 ...
 * @retval None
 */
void mfx_manager_get_version(char *version, int *length)
{
 ...
 * @retval None
 */
void mfx_manager_MagCal_run(MFX_MagCal_input_t *data_in, MFX_MagCal_output_t *data_out)
{
 ...
 * @retval None
 */
void mfx_manager_MagCal_start(int sampletime)
{
 ...
 * @retval None
 */
void mfx_manager_MagCal_stop(int sampletime)
{
